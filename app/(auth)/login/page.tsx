    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white px-12 w-full">
          ...
          >
            <h1 className="text-5xl font-bold mb-6">Welcome to Construxa</h1>
            <p className="text-xl text-blue-100 max-w-md">
              Transform your construction planning with AI-powered CAD analysis and intelligent project timelines.
            </p>
          </motion.div>
        </div>
      </motion.div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-sm bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hover:opacity-80 transition-opacity"
                >
                  Forgot password?
                </Link>
              </div>
